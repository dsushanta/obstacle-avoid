...
public class GameConfig {
    ...
    public static final float WORLD_HEIGHT = 12.f;
    ...
    public static final float PLAYER_BOUND_RADIUS = 0.4f;
    public static final float PLAYER_SIZE = 2* PLAYER_BOUND_RADIUS;
    public static final float OBSTACLE_BOUND_RADIUS = 0.3f;
    public static final float OBSTACLE_SIZE = 2* PLAYER_BOUND_RADIUS;
